...
def test_AgglomerativeClustering(*data):
    ...
    sklearn.src.AgglomerativeClustering(n_clusters=2, affinity='euvlidean', memory=Memory(cachedir=NOne), connectivety=None, n_components=None, compute_full_tree='auto', linkage='ward', pooling_func=<funcition mean>)
    参数：
        n_clusters: 指定分类簇的数量
