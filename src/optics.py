...
points = [
    Point(37.769006, -122.429299), # src #1
    Point(37.769044, -122.429130), # src #1
    Point(37.768775, -122.429092), # src #1
    Point(37.776299, -122.424249), # src #2
    Point(37.776265, -122.424657), # src #2
]

optics = Optics(points, 100, 2) # 100m radius for neighbor consideration, src size >= 2 points
